/*
 * Jasons-Tresor — Voller-Knoten-Init: Status-Widget (17) → Membran (15) → Siegel (16)
...
(function () {
  ...
  var REPO_URL = "https://github.com/lausiklauskn-png/Jasons-Tresor";
  ...
  function boot() {
    ...
    if (window.SbkimWidget && typeof window.SbkimWidget.init === "function") {
      try {
        ...
        console.info("[Jasons-Tresor] Status-Widget (Modul 17) gemountet.");
      } catch (e) { console.warn("[Jasons-Tresor] Status-Widget übersprungen:", e); }
    }
    ...
    widgetReady.then(function () {
      if (window.SbkimMembrane && typeof window.SbkimMembrane.init === "function") {
        try {
          ...
          console.info("[Jasons-Tresor] Membran (Modul 15, Wächter) aktiv.");
        } catch (e) { console.warn("[Jasons-Tresor] Membran übersprungen:", e); }
      }
      if (window.SbkimSiegel && typeof window.SbkimSiegel.init === "function") {
        try {
          window.SbkimSiegel.init({
            ...
            ribbonText: "Jasons-Tresor",
          });
          console.info("[Jasons-Tresor] Siegel (Modul 16) — Selbst-Prüfung läuft (Bronze/Gold).");
        } catch (e) { console.warn("[Jasons-Tresor] Siegel übersprungen:", e); }
      }
    });
    ...
    if (window.SbkimApoptose && typeof window.SbkimApoptose.init === "function") {
      ...
      } catch (e) { console.warn("[Jasons-Tresor] Apoptose übersprungen:", e); }
    }
  }
